 ...
 * Description: Implï¿½mentation des fonctions du module labyrinthe_io
 *
...
int selection_menu(int grille_chargee)
{
    ...
    do
    {
        //Affichage du choix des grilles
        printf("MENU\n");
        ...
        //Saisi du choix de grille de l'usager
        scanf("%i", &grille_chargee);

        //Traitement de selection de l'usager
...
void menu_charger_labyrinthe (char* buf_nom_fichier, int buf_taille)
{
    ...
    {//On s'assure que le fichier ne fini pas avec un saut de ligne
