...
Auteur: Cory Alejandra Herrera Gallego, Hoang Yen Pham
 ...
 * Date: 2023/10/30
 * Description: Demande a l'usager de saisir un nom de fichier correspondant au fichier contenant
 * le labyrinthe a charger.
 * Parametres:
 * - buf_nom_fichier (chaine de caracteres): chaine de caracteres dans laquelle sera stockee le nom du fichier saisi.
 * - buf_taille (entier): Taille maximale de la chaine de caractere a lire depuis la console.
 * Retour: Aucun.
 * Parametres modifies: buf_nom_fichier. */
