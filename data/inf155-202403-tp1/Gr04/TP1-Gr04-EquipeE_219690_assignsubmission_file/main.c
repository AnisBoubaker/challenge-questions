/*
 * Module qui simule le chargement du labyrinthe et qui
...
int main(void) {
    ...
    do {
        ...
        fflush(stdin); // Flush buffer after scanf https://stackoverflow.com/questions/2907062/fgets-instructions-gets-skipped-why
