...
Auteur: Anastassia Gaboury, Yeasmin Begum, Sandra Maria Stoia, Mitsuko Nathalie Enchandia
...
- solution_partielle: pile de coordonnées qui comprend les coordonnées de la solution en
 cours d'élaboration.
- nb_deplacements_possibles : adresse où stocker le nombre de déplacements possible trouvés.
- deplacements_possibles: tableau d'entiers (taille 4x2) qui contiendra le résultats: les coordonnées des
cases où un déplacement est possible depuis la position actuelle
(max 4 possibilités).
Retour : Aucun
 Paramètres modifiés : nb_deplacement, deplacements_possibles.
*/
