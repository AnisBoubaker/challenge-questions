...
/*
Fonction: test_lab_afficher_grille
Description: Cette fonction teste si l'affichage de la grille. Cette fonction crée une grille exemple qu'elle affiche
sans pile solution. Elle affiche ensuite la grille avec sa pile solution, puis elle teste ce qui se passerait dans le
cas ou la hauteur et la largeur ne correspondent pas aux dimensions de la grille. La fonctionnalité est testée
visuellement dans la console. Cette fonction ne teste pas un cas ou la grille ne serait pas composé que de zéros et de
uns car cela dépend de la fonctionnalité de la fonction charger_labyrinthe.
 */
...
/*
Fonction: test_lab_choisir_deplacement
Description: Fonction pour tester la fonction lab_choisir_deplacement. Cette fonction teste si l'indice retourné
est dans la bonne intervalle et affiche l'indice dans la console. Elle répète cela 10 fois pour que l'on puisse voir
si l'indice est obtenu aléatoirement. Cette fonction test uniquement avec un tableau et un nombre de déplacements car
la fonction testée ne dépend pas du tableau et renvoie un indice selon le nombre d'éléments du tableau uniquement.
 */
