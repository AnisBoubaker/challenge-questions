...
#define TAILLE_MAX_Pile 1000 //Taille maximale d'une pile
...
affiche à l'écran la grille avec une solution partielle à chaque fois qu'une case est ajoutée à la solution.
...
- pile_solution : (tableau 2D) pile de coordonnées. La pile doit avoir été initialisée
                    avant d'appeler cette fonction. Les coordonnées de la solution seront empilées dans cette pile.
- debug : (entier) valeur booléenne. Si sa valeur est Vraie, la fonction affichera la grille au fur et à mesure qu'on ajoute des cases à la solution.
