...
#ifndef LABYRINTHE_IO_H_
#define LABYRINTHE_IO_H_
...
Paramètres:
- buf_nom_fichier (chaine de caractères): chaine de caractères dans laquelle sera stockée le nom du fichier saisi.
