...
int selection_menu(int grille_chargee)
{
    ...
    int choix; // choix de l'usager ( 1 a 4)
    ...
    do
    {
        ...
        if (choix != 1 && choix != 2 && choix != 3 && choix != 4) { // Aucun choix
            printf("Choix est invalide!\n");
            system("pause");
        } else if (choix == 2 && grille_chargee == 0) { // Aucune grille mais l'usager entre la resolution 2
            printf("Choix est invalide!\n");
            system("pause");
            choix = 0;
        } else if (choix == 3 && grille_chargee == 0) { // Aucune grille mais l'usager entre la resolutions 3
            printf("Choix est invalide!\n");
            system("pause");
            choix = 0;
        }
