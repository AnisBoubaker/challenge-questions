...
Auteurs: Anis Boubaker

Date: 2017-02-13 (contributions du professeur Anis Boubaker)
*/
...
Description: Vérifie si la pile en parametre contient les coordonnées (ligne, colonne).
...
- colonne (pointeur d'entier): Adresse mémoire où stocker l'abscisse dépilée
Retour: Aucun.
Parametres modifiés: *ligne, *colonne.
*/
