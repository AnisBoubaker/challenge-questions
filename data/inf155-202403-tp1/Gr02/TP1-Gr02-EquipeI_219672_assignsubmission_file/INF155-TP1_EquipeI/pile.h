...
Description: Empile les coordonnées new_ligne et new_colonne reéues en
			 paramètre.
Arguments:
...
Arguments:
- pile (tableau d'entiers): Tableau contenant la structure de pile
- ligne (pointeur d'entier): Adresse mémoire o� stocker l'ordonnées dépilée
- colonne (pointeur d'entier): Adresse mémoire o� stocker l'abscisse dépilée
...
Antécèdents: On suppose que le tableau pile_copie a une taille supérieure ou égale au
