...
Description: Ensemble de fonction pour choisir et charger la grille du labyrinthe
Auteur:
Tommy Parent,
...
#define TAILLE_MAX_NOM_FICHIER 100 //Taille maximale (en caracateres) du nom de fichier
