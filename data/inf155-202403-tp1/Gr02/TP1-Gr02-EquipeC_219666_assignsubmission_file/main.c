/*
 * Fichier: main.c
 * Description: Travail pratique visant a reoudre un labyrinthe trouvant un chemin
 * qui mene vers la sortie du labyrinthe en partant de son entree.
 *
 * Auteur: Versha Aamir
 *
...
int main() {
    ...
    /*** PARTIE 2: Fonction qui affiche la grille du labyrinthe***/
    ...
    /*** PARTIE 3: Fonction qui calcule les deplacements possibles***/
    ...
    /** PARTIE 4 : Fonction qui choisit un deplacement aléatoire parmi les deplacements possibles ***/
    ...
    /*** PARTIE 5: Fonction qui vérifie si les cases sont adjacentes ***/
    ...
    /*** PARTIE 6 : Vérifier si la position est une sortie *****/
    int position[2];
