...
/*
Retourne une date dont les composantes sont reçues en paramètre. La fonction vérifie la validité de la date: les jours ne peuvent être <1 ou >31, en s'assurant que ça correspondent au mois. Les années sont bissextiles si elle est:
...
#endif //EXERCICE_MACHINES_T_DATE_H
